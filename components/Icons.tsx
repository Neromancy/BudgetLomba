...
// FIX: Updated all icon components to correctly handle the `title` prop for accessibility by rendering a <title> element.
// FIX: Add optional title to IconProps to allow passing a title for accessibility.
...
export const TransactionsIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    {title && <title>{title}</title>}
...
export const GoalsIcon: React.FC<IconProps> = ({ title, ...props }) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    {title && <title>{title}</title>}
...
export const LoadingSpinner: React.FC<IconProps> = ({ title, ...props }) => (
